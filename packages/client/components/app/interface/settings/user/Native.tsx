    ...
    <Column gap="lg">
      <CategoryButton.Group>
        <CategoryButton
          ...
          description={
            <Trans>Launch Cooey Club when you log into your computer.</Trans>
          }
        >
        ...
        {autostart() &&
          CheckboxButton(
            ...
            t`Cooey Club will start in the system tray.`,
          )}
        {CheckboxButton(
          "minimiseToTray",
          "cancel_presentation",
          t`Minimise to Tray`,
          t`Instead of closing, Cooey Club will hide in your tray.`,
        )}
        {CheckboxButton(
          "customFrame",
          "web_asset",
          t`Custom window frame`,
          t`Let Cooey Club use its own custom titlebar.`,
        )}
      </CategoryButton.Group>
      ...
      <CategoryButton.Group>
        {CheckboxButton(
          ...
          "groups_2",
          t`Discord RPC`,
          t`Rep Cooey Club using Discord rich presence.`,
        )}
        {CheckboxButton(
          "spellchecker",
          "spellcheck",
      ...
      <CategoryButton.Group>
        ...
        >
          <Trans>Cooey Club for Desktop</Trans>
        </CategoryButton>
      </CategoryButton.Group>
    </Column>
  );
